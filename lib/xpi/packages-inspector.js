...
exports.getPackage = function (packagePath) {
  ...
  if (!fs.existsSync(packageManifest)) return null;
...
exports.getPackages = function (rootPath, packages) {
  ...
  if (fs.existsSync(inDirManifest)) {
...
function getFilesNameFromDirList(root_dir, list) {
  ...
  for each(var name in list) {
    ...
    if (!fs.existsSync(dir)) throw new Error("Unable to find "+name+" directory in : "+root_dir);
